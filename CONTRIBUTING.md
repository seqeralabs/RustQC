...
RSeQC reference outputs in `benchmark/RSeQC/` are generated with [RSeQC 5.0.4](https://rseqc.sourceforge.net/) via Docker. See `benchmark/README.md` for reproduction instructions.
