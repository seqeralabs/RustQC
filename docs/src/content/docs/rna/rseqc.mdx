...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/read_duplication/GM12878_REP1.DupRate_plot.png`} alt="RSeQC read duplication plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/read_duplication/GM12878_REP1.markdup.sorted.DupRate_plot.png`} alt="RustQC read duplication plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/junction_annotation/junction_annotation.splice_events.png`} alt="RSeQC splice events plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/junction_annotation/GM12878_REP1.markdup.sorted.splice_events.png`} alt="RustQC splice events plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |

#### Splice junctions

| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/junction_annotation/junction_annotation.splice_junction.png`} alt="RSeQC splice junction plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/junction_annotation/GM12878_REP1.markdup.sorted.splice_junction.png`} alt="RustQC splice junction plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/junction_saturation/junction_saturation.junctionSaturation_plot.png`} alt="RSeQC junction saturation plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/junction_saturation/GM12878_REP1.markdup.sorted.junctionSaturation_plot.png`} alt="RustQC junction saturation plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
...
| RSeQC | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/rseqc/inner_distance/inner_distance.inner_distance_plot.png`} alt="RSeQC inner distance plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> | <img src={`${base}benchmarks/large/rseqc/inner_distance/GM12878_REP1.markdup.sorted.inner_distance_plot.png`} alt="RustQC inner distance plot" style="background: white; border-radius: 8px; padding: 0.25rem;" /> |
