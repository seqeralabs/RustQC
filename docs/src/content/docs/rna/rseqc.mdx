...
<Aside type="note" title="Minor differences from upstream tin.py">
...
RustQC completes TIN as part of its single pass in under 42 minutes total.
...
in under 42 minutes total (inclusive of all other analyses).

| Metric      |  RSeQC | RustQC |
| ----------- | -----: | -----: |
| TIN mean    | 68.287 | 68.287 |
| TIN median  | 75.921 | 75.921 |
| TIN std dev | 23.959 | 23.959 |

TIN values are identical between RSeQC and RustQC.
