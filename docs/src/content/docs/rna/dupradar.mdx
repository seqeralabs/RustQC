...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/duprateExpDens.png`} alt="dupRadar (R) density scatter plot" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_duprateExpDens.png`} alt="RustQC density scatter plot" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |
...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/duprateExpBoxplot.png`} alt="dupRadar (R) duplication rate boxplot" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_duprateExpBoxplot.png`} alt="RustQC duplication rate boxplot" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |
...
| dupRadar (R) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/dupRadar/expressionHist.png`} alt="dupRadar (R) expression histogram" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/RustQC/GM12878_REP1.markdup.sorted_expressionHist.png`} alt="RustQC expression histogram" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |
