...
| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (Total).png`} alt="Qualimap coverage profile (total)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (Total).png`} alt="RustQC coverage profile (total)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |

#### Coverage Profile Along Genes (High)

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (High).png`} alt="Qualimap coverage profile (high)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (High).png`} alt="RustQC coverage profile (high)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |

#### Coverage Profile Along Genes (Low)

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Coverage Profile Along Genes (Low).png`} alt="Qualimap coverage profile (low)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Coverage Profile Along Genes (Low).png`} alt="RustQC coverage profile (low)" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |

#### Transcript coverage histogram

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Transcript coverage histogram.png`} alt="Qualimap transcript coverage histogram" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Transcript coverage histogram.png`} alt="RustQC transcript coverage histogram" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |

#### Reads Genomic Origin

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Reads Genomic Origin.png`} alt="Qualimap reads genomic origin" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Reads Genomic Origin.png`} alt="RustQC reads genomic origin" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |

#### Junction Analysis

| Qualimap (Java) | RustQC |
|:---:|:---:|
| <img src={`${base}benchmarks/large/qualimap/Qualimap/Junction Analysis.png`} alt="Qualimap junction analysis" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> | <img src={`${base}benchmarks/large/qualimap/RustQC/Junction Analysis.png`} alt="RustQC junction analysis" style={{ background: "white", borderRadius: "8px", padding: "0.25rem" }} /> |
