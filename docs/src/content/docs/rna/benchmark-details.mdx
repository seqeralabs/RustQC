...
- TIN takes 9h 45m - more than 14x RustQC's total runtime for everything
- dupRadar alone takes 2h 14m 24s - more than 3x RustQC's total runtime
...
- **RSeQC tools:** all data values and R plotting scripts match Python RSeQC.
  ...
  variation from random subsampling (see [RSeQC](/rna/rseqc/))
