...
Your BAM files **must** have PCR duplicates **marked** (SAM flag `0x400`) but **not removed**. RustQC needs both duplicate and non-duplicate reads present to calculate duplication rates.
