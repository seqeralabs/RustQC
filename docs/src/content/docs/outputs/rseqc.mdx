...
See the dedicated [TIN output page](/outputs/tin/) for full details, configuration
options, and interpretation guidance.
...
For details on minor differences from upstream `tin.py`, see the [TIN output page](/outputs/tin/#compatibility).
