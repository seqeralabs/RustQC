...
<FileTree>
  - dupradar/ - sample_dupMatrix.txt Duplication matrix (core data table) -
  sample_intercept_slope.txt Fitted model intercept and slope -
  sample_duprateExpDens.png Density scatter plot - sample_duprateExpDens.svg -
  sample_duprateExpBoxplot.png Duplication rate boxplot -
  sample_duprateExpBoxplot.svg - sample_expressionHist.png Expression histogram
  - sample_expressionHist.svg - sample_intercept_slope_mqc.tsv MultiQC general
  statistics - sample_duprateExpDensCurve_mqc.txt MultiQC fitted curve data
</FileTree>
